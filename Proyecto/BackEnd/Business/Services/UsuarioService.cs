    ...
    public class UsuarioService : BaseService, IDisposable
    {
        ...
        public Usuario VerifyCredentials(string username, string password)
        {
            ...
            try
            {
                ...
                usuario.persona.persona_Id = table.Rows[0]["Person_id"].ToString();
        ...
        public void Guardar(Usuario usuario, bool nuevo)
        {
            string query;
            ...
            try
            {
                ...
                query = "exec Usuario_Guardar '" + usuario.usuario_Id.ToString() + "'" +
                        ",'" + usuario.nombre + "'" +
                        ",'" + usuario.password + "'" +
